...
import titleImage from "../assets/learn.png";

function TitleSection() {
  return (
    <div
      className="p-6 sm:p-10 mx-auto bg-[#F97316] flex flex-col md:flex-row mb-0 justify-center"
    ...
    >
      ...
      {/* Text Section */}
      <div className="w-full md:w-1/2 text-center md:text-center flex flex-col justify-center">
