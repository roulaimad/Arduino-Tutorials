...
function TitleSection() {
  return (
    <div className="p-10 max-w-6xl mx-auto bg-[#F97316] flex flex-row">
      ...
      <div className="w-1/2 text-right flex flex-col justify-center">
        <h1
          className="font-bold text-6xl pb-10 text-white uppercase"
          style={{ fontFamily: "Cairo, sans-serif" }}
        >
          دروس أردوينو للمبتدئين
        </h1>
        <h2
          className="font-medium text-2xl text-white uppercase"
          style={{ fontFamily: "Cairo, sans-serif" }}
        >
